// (c) ammap.com | SVG (in JSON format) map of U.S. Virgin Islands - High
// areas: {id:"VI-ST"},{id:"VI-SJ"},{id:"VI-SC"}
AmCharts.maps.usVirginIslandsHigh={
	"svg": {
		"defs": {
			"amcharts:ammap": {
				"projection":"mercator",
		...
		"g":{
			"path":[
				...
				},
				{
					"id":"VI-SJ",
					"title":"St. John",
					"d":"M564.9,76.21L609.44,91.08L632.22,87.13L625.3,69.31L595.61,53.45L570.86,42.55L544.13,37.59L488.69,22.73L473.84,30.65L480.76,43.52L451.06,52.43L423.35,64.34L398.61,101.93L423.34,124.69L506.47,116.77L559.9,145.49L570.82,104.92L553.01,81.16L564.9,76.21z"
				},
				{
					"id":"VI-SC",
					"title":"St. Croix",
