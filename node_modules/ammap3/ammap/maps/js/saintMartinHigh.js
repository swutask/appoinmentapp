// (c) ammap.com | SVG (in JSON format) map of Saint Martin - High
// areas: {id:""},{id:""}
AmCharts.maps.saintMartinHigh={
	"svg": {
		"defs": {
			"amcharts:ammap": {
				"projection":"mercator",
